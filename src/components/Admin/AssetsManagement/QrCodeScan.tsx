...
const QrCodeScan = ({ onClose }: Props) => {
  return (
    <div className="bg-[#F7F9FC] w-[715px] h-[538px] px py- rounded-lg shadow-lg relative ">
      <img
        src={closeIcon}
        ...
        onClick={onClose}
      />
      <h1 className=" text-greyText font-medium text-2xl mb-12">
        Scan QR Code
      </h1>
