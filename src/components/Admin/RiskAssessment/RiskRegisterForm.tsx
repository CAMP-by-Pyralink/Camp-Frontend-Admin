        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-4 px-12">
          ...
          {/* <div className="flex gap-4">
            <button
              type="button"
              onClick={() =>
                setFormData({ ...formData, mitigationStrategy: "Manual" })
              }
              className={`flex-1  py-1  rounded-md ${
                formData.mitigationStrategy === "Manual"
            ...
            <button
              type="button"
              onClick={() =>
                setFormData({ ...formData, mitigationStrategy: "AI" })
              }
              className={`flex-1 p-2 rounded-md ${
                formData.mitigationStrategy === "AI"
